                ...
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5 style="float: left;">Network Setting</h5>
                        </div>
                            ...
                            <div class="row">
                                <div style="padding-top: 3%;" class="setting col-sm-12 ">
                                    <form role="form" id="form" method="POST" action="/network-setting" class="form-horizontal">
                                        ...
                                        <div class="form-group"><label style=" float: left;" for="ipAddress"
                                                                       class="setting col-sm-3 control-label">Ip Address
                                            </label>
                                            <div class="setting col-sm-8"><input type="text" name="ipAddress"
                                                                                 id="ipAddress" value="{{$ipAddress}}"
                                                                                 class="form-control"></div>
                                        </div>
                                        <div class="form-group"><label style=" float: left;" for="subnetMask"
                                                                       class="setting col-sm-3 control-label">Subnet
                                                Mask
                                            </label>
                                        ...
                                        <div class="form-group"><label style=" float: left;" for="gateWay"
                                                                       class="setting col-sm-3 control-label">Gate Way
                                            </label>
                                            <div class="setting col-sm-8">
                                        ...
                                        <div class="form-group"><label style=" float: left;" for="dns"
                                                                       class="setting col-sm-3 control-label">DNS-NameServer
                                            </label>
                                            <div class="setting col-sm-8">
                                        ...
                                        <div class="form-group"><label style=" float: left;"
                                                                       class="setting col-sm-3 control-label">
                                            </label>
                                            <div class="setting col-sm-8">
                                                <button style="float: left;" class="btn btn-primary" type="submit">Save
                                                </button>
                                            </div>
                                        </div>
                                    </form>
